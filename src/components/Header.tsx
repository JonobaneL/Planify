...
import { LuBell, LuCircleHelp, LuSettings, LuUserRoundPlus } from "react-icons/lu";
...
const Header = () => {
  ...
  return (
    <header className="flex h-14 w-full items-center justify-between border-b bg-p-background pr-6 shadow-sm">
      <div className={`${isOpen ? "w-60" : "w-16"} flex h-full items-center justify-center border-r shadow-sm`}>
        <p className="text-2xl font-semibold text-primary-b">{isOpen ? "Planify" : "P"}</p>
      </div>
